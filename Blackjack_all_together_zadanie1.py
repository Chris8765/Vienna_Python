# TASK:
# Before starting a new round, make sure that the deck contains enough cards.
# If this is not the case, readd the card set and shuffle its contents.
...
class BJ_Game(object):
    ...
    def play(self):
        ...
        print("***Przed grą: " + str(len(self.deck.cards)) + " karty.***")
        ...
        print("***Po grze: " + str(len(self.deck.cards)) + " karty***")
